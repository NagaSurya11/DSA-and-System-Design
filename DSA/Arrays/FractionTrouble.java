...
public class FractionTrouble {
    ...
    // method to find the largest fraction less than or equal to a given fraction
    // n/d
    public int[] LargestFraction(int n, int d) {
        // initialize variables to store numerator and denominator of the largest
        // fraction found
        int r = 0, s = 1;
        ...
        for (int q = limit; q >= 2; q--) {
            // calculate the numerator using the given fraction n/d and current denominator
            // q
            int p = (n * q - 1) / d;
